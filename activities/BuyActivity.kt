...
import com.example.pays.activities.OrderActivity
import com.example.pays.adapters.BuyAdapter
...
class BuyActivity : AppCompatActivity() {
    ...
    private fun initBuy() {
        ...
        binding.apply {
            recyclerViewBuy.layoutManager = LinearLayoutManager(
                this@BuyActivity,
    ...
    private fun buyClick() {
        binding.btnClick.setOnClickListener {
            ...
            val paymentParameters = PaymentParameters(
                amount = Amount(BigDecimal(totalSum), Currency.getInstance("RUB")),
                title = title,
