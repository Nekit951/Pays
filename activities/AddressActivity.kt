...
import com.example.pays.activities.AddressAddActivity
import com.example.pays.adapters.AddressAdapter
...
class AddressActivity : AppCompatActivity() {
    ...
    private fun initAddress() {
        binding.apply {
            ...
            if(userId.isNotEmpty()){
                database.child(userId).child("address").addValueEventListener(object :
                    ValueEventListener {
                    ...
                    override fun onCancelled(error: DatabaseError) {
                        Log.e("DATABASE_ERROR", "Ошибка чтения адреса: ${error.message}")
                    }
